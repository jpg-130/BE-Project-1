...
m_trainingsetfeatures = features[0:15]
m_trainingsetlabels = labels[0:15]

print("Training Samples...",len(m_trainingsetfeatures))
print("Training Labels...",len(m_trainingsetlabels))
#print(m_trainingsetlabels)
m_testingsetfeatures = features[15:22]
m_testingsetlabels = labels[15:22]
...
for i in range(0,len(m_testingsetfeatures)):
    ...
    sheet1.write(i+1, 0, str(max(np.round(scores, 3))))
